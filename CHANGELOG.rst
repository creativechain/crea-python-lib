...
0.20.18
-------
* get_blog, get_followers and get_following works with api.creary.net (issue #146)
* creapy newaccount - possible to provide owen, posting, active, and memo pub_key to create a new account
* https://rpc.usecrea.com added to nodelist
* NodeList.get_nodes() has a new parameter exclude_limited. When True (default value), api.creary.net is not returned as node.
...
0.20.17
-------
* Fix transfer rounding error, which prevent transfering of e.g. 1.013 CREA.
* get_account_votes works again with api.creary.net
* Use secp256k1prp as better replacement for secp256k1

0.20.16
-------
* Fix creapy walletinfo and sign

0.20.15
-------
* Improve file reading for creapy sign and broadcast
* add option to write file for creapy sign
* Disable not working nodes
* add missing prefix to comment_options op (by crokkon)
* fix creapy verify --use-api (by crokkon)
...
* connect for creapy createwallet (thanks to crokkon, PR #133)

0.20.13
-------
* creapy post improved
* creapy ImageUploader added
...
* percent-crea-dollars and max-accepted-payout added to creapy post

0.20.10
-------
* update_account_keys added for changing account keys
* comment, witness, account classes fixed for chains without CBD
* RC costs adapted on changes from 0.20.6
* VIT chain fixed
* update_account_keys function added to account
* creapy commands for post, reply and beneficiaries added
...
* Add claimaccount to creapy and some improvements for crea.sbd_symbol
* newaccount adapted for HF20 and can be used to create claimed account
* Correct operationids for WLS
* Improve crea.refresh_data() reading
...
* dict key words adapted to cread for get_manabar() and get_rc_manabar()
...
* add comment, vote, transfer RC costs in account.print_info() and creapy power
* Shows number of possible comments, votes, tranfers with available RCs in account.print_info() and creapy power
* get_rc_cost was added to crea to calculation RC costs from resource count
...
* print_info fixed()
* get_api_methods() and get_apis() added to Crea
...
* https://cread-appbase.creary.net added to nodelist

0.20.0
------
* Fully supporting hf20
* add get_resource_params(), get_resource_pool(), claim_account(), create_claimed_account() to Crea
...
* witness_set_properties() added to crea
* creapy witnessproperties added
* creapy pricefeed uses witnessproperties  when witness wif is provided
...
* Add get_vote_pct_for_CBD, sbd_to_vote_pct and sbd_to_rshares by flugschwein
* creabase/objects: fix serialization of appbase trx by crokkon
...
0.19.53
-------
* Add userdata and featureflags to creapy
* cread.pevo.science and cread.creagigs.org removed from Nodelist
...
0.19.50
-------
* Class to access Creary Conveyor instances added by crokkon
* Option added to loed custom chains into the Crea object

0.19.49
-------
* add get_parent() to comment
* fix for creapy reward
* fix #46 (used power calculation may treat downvotes incorrectly) by crokkon
* fix #49 (discussions: set crea inst. as keyword argument) by crokkon
...
* Fix #57 (CreaConnect expects double quotes in JSON)
...
* upvote and downvote in creapy fixed
...
* First testing version of crea.snapshot with example added (thanks to crokkon for his example)
...
* Add conversion of datetime objects to timestamp in get_crea_per_mvest
* Fix crea for crea update 0.19.5 and 0.19.10
...
-------
* Bug fixes
* Bool variables for CreaConnect link creation fixed
* Account handling in crea.account is improved
* json_metadata property added to crea.account
* missing addTzInfo added to crea.blockchain
* json_metadata update for comment edit improved
* use_stored_data option added to crea.info()
* poloniex removed and huobi and ubpit added to crea_btc_ticker()
...
* creapy updatenodes added, this command can be used to update the nodes list
...
* btc_usd_ticker, crea_btc_ticker, crea_usd_implied and _weighted_average added to Market
* creapy witnesses uses the proxy name when set
* creapy keygen added, for creating a witness signing key
* creapy parsewif improved
...
* creaconnect v2 integration added
...
* url_from_tx add to creaconnect for creating a URL from any operation
* login demo add added
* add -l option to creapy for creating URL from any operation
* add -s option to creapy for broadcasting via creaconnect
* addtoken, deltoken and listtoken added to creapy

0.19.32
-------
* bug fix and improvements for creapy curation

0.19.31
-------
* datetime.date is also supported
* creapy curation improved
...
* MissingKeyError is raised when a wrong key is set by Crea(keys=[])
...
* Export option for votes and curation command under creapy added
...
0.19.28
-------
* Improve rewards command in creapy
* estimate_virtual_op_num improved and small bug fixed
* CBD value in Comment always converted to Amount
* accuracy renamed to stop_diff
* Doku of estimate_virtual_op_num improved
* Unit test for estimate_virtual_op_num added
* creapy rewards command renamed to pending
* new creapy command: rewards shows now the received rewards
...
* websocket will be created again for each Crea instance
* A node benchmark which uses threads added to examples
* Documentation improved
* Optional threading added to creapy pingnode (use --threading with --sort)
...
0.19.24
-------
* AsciiChart for creapy: pricehistory, tradehistory and orderbook
* Sort nodes regarding their ping times (creapy ping --sort --remove)
* currentnode and nextnode skip not working nodes
* Memory consumption fer requests and websocket reduced when creating more instances of crea
* trade_history added to market
* Issue #4 fixed
* Crea(use_condenser=True) activates condenser_api calls for 19.4 nodes

0.19.23
-------
* new function for creapy added: power, follower, following, muter, muting, mute, nextnode, pingnode, currentnode
...
0.19.22
-------
* creapy (command line tool) improved and all missing functions which are available in creapy are added
* new functions to creapy added: witnesses, walletinfo, openorders, orderbook and claimreward
...
* serveral bug fixes and improvements
* coverage improved
* crea.get_blockchain_version added
* post and comment_options moved from crea.commment to crea.crea
...
* benchmark added
* Example for speed comparison with crea-python added
...
0.19.13
-------
* crea is now in the beta state, as now 270 unit tests exists
...
* bug fixes
* CLI tool added
* crea added to conda-forge
* more unittests

0.19.7
------
* works on python 2.7
* can be installed besides crea-python
...
* Add Witness
* Several bugfixes
* Added all transactions that are supported from crea-python
* New library name planned: crea
...
* Replaced all BitShares by Crea
* Flake8 fixed
* Unit tests are working
* renamed to crea
* Docs fixed
* Signing fixed
* pycrea: Account, Amount, Asset, Block, Blockchain, Instance, Memo, Message, Notify, Price, Crea, Transactionbuilder, Vote, Witness are working
