...
class Testcases(unittest.TestCase):
    ...
    def test_authorperm_resolve(self):
        self.assertEqual(resolve_authorperm('https://d.tube/#!/v/pottlund/m5cqkd1a'),
                         ('pottlund', 'm5cqkd1a'))
        self.assertEqual(resolve_authorperm("https://creary.net/witness-category/@gtg/24lfrm-gtg-witness-log"),
    ...
    def test_derive_beneficiaries(self):
        ...
        t = "holger80:30,creabot:40"
        b = derive_beneficiaries(t)
        self.assertEqual(b, [{"account": "creabot", "weight": 4000}, {"account": "holger80", "weight": 3000}])
        t = "holger80:30,creabot"
        b = derive_beneficiaries(t)
        self.assertEqual(b, [{"account": "creabot", "weight": 7000}, {"account": "holger80", "weight": 3000}])
        t = ["holger80:30", "creabot"]
        b = derive_beneficiaries(t)
        self.assertEqual(b, [{"account": "creabot", "weight": 7000}, {"account": "holger80", "weight": 3000}])
