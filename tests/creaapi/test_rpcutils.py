...
class Testcases(unittest.TestCase):
    def test_is_network_appbase_ready(self):
        self.assertTrue(is_network_appbase_ready({'CREA_BLOCKCHAIN_VERSION': '0.19.10'}))
        self.assertTrue(is_network_appbase_ready({'CREA_BLOCKCHAIN_VERSION': '0.19.10'}))
        self.assertFalse(is_network_appbase_ready({'CREARY_BLOCKCHAIN_VERSION': '0.19.2'}))
        self.assertFalse(is_network_appbase_ready({'CREARY_BLOCKCHAIN_VERSION': '0.19.2'}))
