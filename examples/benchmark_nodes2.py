...
from crea.utils import parse_time, formatTimedelta, construct_authorperm, resolve_authorperm, resolve_authorpermvoter, construct_authorpermvoter, formatTimeString
...
if __name__ == "__main__":
    ...
    if set_default_nodes:
        ...
        print("creapy set nodes " + str(working_nodes))
